...
class Region:
    ...
    def __init__(self, robot_pos):
        ...
        #self.abs_min_xyz = self.robot_pos + np.array([0.000, -0.320, -0.580])
        #self.abs_max_xyz = self.robot_pos + np.array([0.870, +0.320, +0.000])
        self.abs_min_xyz = self.robot_pos + np.array([0.200, -0.320, -0.580])
        self.abs_max_xyz = self.robot_pos + np.array([0.870, +0.320, -0.200])
